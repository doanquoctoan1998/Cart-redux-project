                                ...
                                <div className="item carousel-item active">
                                    <div className="row">
                                        <div className="col-sm-3">
                                            <div className="thumb-wrapper">
                                                <div className="img-box">
                                                    <img src="https://www.tutorialrepublic.com/examples/images/products/ipad.jpg" className="img-responsive img-fluid" alt="" />
                                                </div>
                                        ...
                                        <div className="col-sm-3">
                                            <div className="thumb-wrapper">
                                                <div className="img-box">
                                                    <img src="https://www.tutorialrepublic.com/examples/images/products/headphone.jpg" className="img-responsive img-fluid" alt="" />
                                                </div>
                                                <div className="thumb-content">
                                        ...
                                        <div className="col-sm-3">
                                            <div className="thumb-wrapper">
                                                <div className="img-box">
                                                    <img src="https://www.tutorialrepublic.com/examples/images/products/macbook-air.jpg" className="img-responsive img-fluid" alt="" />
                                                </div>
                                                <div className="thumb-content">
                                                    <h4>Macbook Air</h4>
                                        ...
                                        <div className="col-sm-3">
                                            <div className="thumb-wrapper">
                                                <div className="img-box">
                                                    <img src="https://www.tutorialrepublic.com/examples/images/products/nikon.jpg" className="img-responsive img-fluid" alt="" />
                                                </div>
                                                <div className="thumb-content">
                                                    <h4>Nikon DSLR</h4>
